...
app.get('/musicians', async (req, res, next) => {
    ...
    console.log("--------current query object:", req.query)
    ...
    // if firstName query exists, now I want to add a query to find all the musicians where the firstName is = firstNameData
    if(firstNameData){
        query.where.firstName = firstNameData
    }
