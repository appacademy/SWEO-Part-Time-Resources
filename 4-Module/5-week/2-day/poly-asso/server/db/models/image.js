  ...
  class Image extends Model {
    ...
    getImageable(options) {
      ...
      return this[mixin](options);
			...
			/**
			 * this.imageableType === "UserProfile"
			 * 		this[mixin] === this['getUserProfile'] === this.getUserProfile
			 * 
			 * this.imageableType === 'AnyOtherThing'
			 * 		this[mixin] === this['AnyOtherThing] === this.getAnyOtherThing
			 */
    }
