...
app.get("/viewers/:id", (req,res)=>{  
    // console.log(req.params); //{ id: '50' } //see that req.params gives an object and that is what we are working with! (follow the data)
    ...
    const responseData = {
        ...
        movies: ["titanic", "secret life of pets 2", "encanto"]

    }
    res.json(responseData); //this is the response to give back to the client
...
app.get("/info", (req,res)=>{
    console.log("req.query", req.query); //{ message: 'Hello, world!' }
