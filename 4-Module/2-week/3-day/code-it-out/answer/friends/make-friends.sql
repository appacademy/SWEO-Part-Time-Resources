...
-- Step 1: in the SQLite command line (where you connected to the database of your choice), run the SQL query to get all the records from the friends table (SELECT ...)
