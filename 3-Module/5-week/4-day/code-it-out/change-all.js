...
export const changeAll = function(){
    ...
    //hint: what is the datatype that we have selected in step 1? Is it an element, a collection, etc. If it's an array like collection and we want to apply each change to the items inside it, should we convert the collection to an array first? Or use a traditional for loop?
