const select = () => {
    ...
    // note we need to convert it to an array (both NodeList and HTMLCollection cannot use array methods until we convert them to an array w/ Array.from or [...aray])
