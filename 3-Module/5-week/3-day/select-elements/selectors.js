const select = () => {
    ...
    const seeded = document.querySelectorAll("li.seed"); //return a NodeList, need to convert into an array to use array methods. Only seeded.forEach will work for querySelectorAll, but 
