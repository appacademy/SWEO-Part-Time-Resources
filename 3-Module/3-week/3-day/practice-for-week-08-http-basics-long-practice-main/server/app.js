...
app.use(express.urlencoded({ extended: true })); // parsing the body of url encoded
...
app.get('/', function (req, res) {
  ...
  return res.render('index', data); // showing an html page
});
...
app.get('/products', (req, res) => {
  ...
  return res.render('products', data); // 200
});
...
app.post('/products', (req, res) => {
  ...
  nextProductId++;
  res.redirect('/products/' + productId); // 302
});
...
app.use((req, res) => {
  ...
  return res.render('error', data); // status code 404, CT: text/html, body: true
});
// middlewares
