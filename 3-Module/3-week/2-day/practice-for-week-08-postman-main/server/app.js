// external packages
// they are tools that we can use within our application
const express = require('express'); // allows us to set up a robust backend server
const fs = require('fs'); // file system, this allows to read, write, delete anything in our files.
const morgan = require('morgan'); // configurations
const app = express(); // we're creating an instance of express

// middle ware
app.use(express.urlencoded({ extended: true }));
// allows us to set what html format we will use
app.set('view engine', 'pug');

app.use(morgan('dev')); // we're defaulting development configs
