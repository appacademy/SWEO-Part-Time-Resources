...
const { formatAnswer, validateURL } = require('./utils/formats');
...
describe ('02 - Ask for a page that doesn\'t exist', function () {

    before(function(done) {
        answer.request.URL = validateURL(answer.request.URL);
        done();
    })
