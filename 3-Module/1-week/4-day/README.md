...
> Helpful Links: <br>
[MDN Display Property](https://developer.mozilla.org/en-US/docs/Web/CSS/display)<br>
[MDN Inline Elements](https://developer.mozilla.org/en-US/docs/Web/HTML/Inline_elements#Elements)<br>
[MDN Block Elements](https://developer.mozilla.org/en-US/docs/Web/HTML/Block-level_elements#elements)<br>
[MDN Padding](https://developer.mozilla.org/en-US/docs/Web/CSS/padding)<br>
[MDN Border](https://developer.mozilla.org/en-US/docs/Web/CSS/border)<br>
[MDN Margin](https://developer.mozilla.org/en-US/docs/Web/CSS/margin)<br>
[WIKI Names of CSS Colors](https://en.wikipedia.org/wiki/X11_color_names#Color_name_chart)<br>
[MDN Position Property](https://developer.mozilla.org/en-US/docs/Web/CSS/position)<br>
...
[Box Model](https://open.appacademy.io/learn/js-py---pt-may-2022-online/week-13---html-and-css/practice--box-model) (30m)

- Box Model Walkthru

[CSS Colors, Borders and Shadows](https://open.appacademy.io/learn/js-py---pt-may-2022-online/week-13---html-and-css/practice--css-colors--borders--and-shadows) (30m)

- CSS Colors, Borders and Shadows Walkthru

[CSS Positioning](https://open.appacademy.io/learn/js-py---pt-may-2022-online/week-13---html-and-css/practice--css-positioning) (30m)

- CSS Positioning Walkthru

[CSS Wireframes Long Practice](https://open.appacademy.io/learn/js-py---pt-may-2022-online/week-13---html-and-css/css-from-wireframes-long-practice) (until EOD)

**If you finish before class ends, I suggest you continue practicing. Test things out, try to make your own html doc and add css. Create a profile page or something! Have fun with it!**
