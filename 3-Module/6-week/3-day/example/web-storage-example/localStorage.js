window.addEventListener("DOMContentLoaded", (e)=>{
    ...
    if(window.localStorage.getItem("autosave")){
        inputEl.value = window.localStorage.getItem("autosave");
    }
    ...
    inputEl.addEventListener("change", event =>{
        window.localStorage.setItem("autosave", inputEl.value)
    })
})

// to remove local storage key value, then use the .removeItem method: window.localStorage.removeItem("autosave");