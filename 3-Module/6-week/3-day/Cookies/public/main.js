...
function restoreTheme() {
  // //? If you have other cookies
  // // console.log(themeName);
  // // console.log(themeName.split('; '));
  const cookieArr = document.cookie.split('; ');
  const themeCookie = cookieArr.find((el) => el.includes('theme'));
  ...
  // //! if you have no other cookies
  // const themeName = document.cookie.split('=')[1];
  // // console.log(document.cookie) // 'theme=dragon'
  // // console.log(document.cookie.split("=")) // ['theme', 'dragon']
  // // console.log(document.cookie.split("=")[1]) // 'dragon'
...
function restoreName() {
  const cookieArr = document.cookie.split('; ');
  const nameCookie = cookieArr.find((el) => el.includes('name'));
