...
# will fail
person = dict(first_name = "Blake", last_name = "Watts", 1 = 489)
# will pass
...
const person = { firstName: "Blake", lastName: "Watts" };
...
person = {"first_name": "Blake", "last_name": "Watts"}
...
const personLastName = { lastName: "Watts" };

person = { ...person, ...personLastName };
console.log(person);

// spreading objects to a new variable
const personFirstName = {firstName: "Blake"}
const personLastName = {lastName: "Watts"}
...
person = dict(first_name = "Blake")
person_last_name = dict(last_name = "Watts")

person = {**person, **person_last_name}
print(person)

# using ** to create a new dictionary
person_first_name = dict(first_name = "Blake")
person_last_name = dict(last_name = "Watts")
