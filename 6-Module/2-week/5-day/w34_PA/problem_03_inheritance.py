...
class FlyingDragon(Dragon):
    ...
    def encounter(self):
        ...
        base_string += f'It lets you take a selfie and admire its {self._color} scales.' if self._is_good else super(
        ).breathes_fire()
        return base_string
...
# print(test_dragon.fly())                      # Smaug's towering
# wings launch it into the air, creating a powerful blast of wind
