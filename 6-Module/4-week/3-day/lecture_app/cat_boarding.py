...
from app.models import db, Cat, Owner
from app import app
...
with app.app_context():
    ...
    new_owner = Owner(name="Jesse", email="jbrooks@appacademy.io", phone_number=8182924837)
    ...
    #
    print("owner's cats:", new_owner.cats)
    print("cat's owner:", new_cat.owner)
