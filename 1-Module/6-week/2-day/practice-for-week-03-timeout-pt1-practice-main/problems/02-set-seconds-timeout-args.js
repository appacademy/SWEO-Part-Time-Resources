...
// 	// 	cb(...args);
// 	// }, delayInSeconds * Math.pow(10, 3));
// 	setTimeout(cb, delayInSeconds * Math.pow(10, 3), ...args)
// }

const setSecondsTimeoutArgs = (cb, delayInSeconds, ...args) => setTimeout(cb, delayInSeconds * Math.pow(10, 3), ...args)
