...
//       // Adds el to the return array if I return true
//       // Does not add el to the return array if I return false
//       if (typeof el === str) return false;
//       else return true;
//     });
//   };
// }
...
function eliminateType(arr) {
  return (str) => {
    // return array so that we don't mutate original
    const finalArr = [];
    ...
    for (let i = 0; i < arr.length; i++) {
      ...
      // if our currEl type is not the exclude type, push into final
      if (typeof currEl !== str) {
        finalArr.push(currEl);
      }
    }
...
// console.log(eliminateType([2, undefined, 'world', { color: 'red' }, true, 3, [4, 5], 'hello', false]))
