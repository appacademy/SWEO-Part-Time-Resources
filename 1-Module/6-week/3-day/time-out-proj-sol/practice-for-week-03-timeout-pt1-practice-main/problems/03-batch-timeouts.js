...
//   //part1: pairing up the first callback and delay, and pass it to setTimeout
//   //grab the front of callbacks and delay
//   const frontCB = callbacks.shift();
//   const frontDelay = delays.shift();
//   const timeOutObj = setTimeout(frontCB, frontDelay);
//   result.push(timeOutObj);
//   //part2: now do recurse and do part 1:
//   batchTimeouts(callbacks, delays, result);
//   return result;
