/*
Patch notes 2.0:
-added cook dialogue and cooks assistant quest
-added loot goblin simulator
*/
...
function cookNPC() {
    ...
    if (cookQuestStarted === true) {
        if ("egg" in inventory && "milk" in inventory && "flour" in inventory) {
            inventory.egg--;
            inventory.milk--;
            inventory.flour--;
