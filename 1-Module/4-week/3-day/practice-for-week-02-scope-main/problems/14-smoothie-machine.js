...
function smoothieMachine(...sentence){
	return function(...newSmoothie){
		sentence = sentence.concat(newSmoothie)
		return `I'm having a smoothie with ${sentence.join(' and ')}`
	}
}

// [apples, bannanas, berries]
//apples and bannas and berries
