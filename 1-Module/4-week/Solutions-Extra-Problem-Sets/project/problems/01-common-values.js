...
*/
// pull out values of each object
function commonValues(obj1, obj2) {
	let values1 = Object.values(obj1) // [array of values]
	let values2 = Object.values(obj2) // [array]

	return values1.filter(e => values2.includes(e))
}
