...
function exponent(num, power) { //power = 2
    debugger;
    //base case
    if(power === 0){ //anything to the power of 0 will be 1, so if power is 0, return 1
        return 1;
    }

    //if power is positive - we expect to his this if statement here
...
//when we get a maximum call stack size exceeded:
// - our base case is never hit (base case if statement is not working properly)
// - we are not getting closer to the base case or skipping over it