...
function iceCreamShop(flavors, favorite) {
	...
	// ['vanilla', 'strawberry'] // shift
	// ['strawberry'] // shift
	// []

	const shiftedEl = flavors.shift() //shift mutates the flavors
	// return iceCreamShop(flavors.slice(1), favorite)
	return iceCreamShop(flavors, favorite)
}

console.log(iceCreamShop([])) // false
console.log(iceCreamShop(['pistachio'], 'pistachio')) // true
