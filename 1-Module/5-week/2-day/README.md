...
- press and hold ctrl + shift + p (cmd + shift + p for mac) to bring up settings search bar
- search for and click on launch.json
- add the following into the object found there. (if you dont add it to the bottom of the object you will need to add a comma at the end of this)
