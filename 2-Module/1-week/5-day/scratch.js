...
// Classes (Special Functions): are blueprints to create our very own objects which have attributes & behaviors that emulate or model a problem we are trying to represent
...
// Instantiate (invoking): Class is just a framework (blueprint) until it is instantiated (built).

// think function declarations vs. function invocations
// Instance: Object made from a class.

// think of houses(instances) made from a blueprint(class)
// Constructor: handles setup, data initialization, or actions to perform prior to the instantiation of a class object

// TLDR: what setup/prepwork needs to be done before the object is created. Then constructor creates object for us.
// Properties: data or fields that represent the object (nouns and adjectives)

// Also known as: instance varibles, fields, members.
// Instance Methods: actions that the object can perform and what can be done to it (verbs)
...
// Encapsulation (hiding the how): hiding and protecting the implementation details (the how) and properties behind object's methods.
...
// Static Methods: A class method: Invoke it from a CLASS & (they belong to the entire class, not the instance)
...
// Polymorphism: Class methods can have several forms or shapes. There are two main abilities: ability to overload or extend a parent class' methods.
