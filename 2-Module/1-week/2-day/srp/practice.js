...
function bakeThosePies(pieType, pieQuantity, recipe) {
...
function determineRevenue(pieQuantity, recipe, profitMargin = 1.2) {
  ...
  // Calculate the revenue of baking these pies
  return costOfPie * pieQuantity * profitMargin;
}
...
function bakeAndSellPies(pieType, pieQuantity, profitMargin) {
  ...
  // BAKE EM!
  bakeThosePies(pieType, pieQuantity, recipe);

  // DETERMINE TOTAL REVENUE!
  const revenue = determineRevenue(pieQuantity, recipe, profitMargin);
