...
const findAnswer = () => {
    ...
    //   if (counter[key] > greatestInt) {
    //     greatestInt = counter[key]
    //     mostSeenVowel = key
    //   }
    // }
    // return mostSeenVowel;
}
...
const mostFrequentVowel = function (words, counter = {}) {
  ...
  // recursive step
  let splitWordsArray = words.join("").split("");
  let currentChar = splitWordsArray.pop();

  countVowels(counter)

  return mostFrequentVowel(splitWordsArray, counter)
}
