...
function processCommand() {
  ...
  rl.question('> ', (cmd) => {
    ...
    } else if (cmd.startsWith("debug items")) {

      let itemPrinter = function () {
        console.log(this.items)
      };

      let playerPrinter = itemPrinter.bind(player)
      playerPrinter();

      let worldRooms = Object.values(world.rooms)
      worldRooms.forEach(room => {
        itemPrinter.call(room)
      })
