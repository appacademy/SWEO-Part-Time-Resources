...
//1) Context is the object that `this` inside of a function belongs to, or what `this` represents when the function is executed

//2) Whichever or wherever the object invokes the function/method (that has `this` in it), that object becomes the context for `this` in that function
...
let tomTheCat = new Cat(); //instantiated a new instance (tomTheCat) that is an object ob the Cat class.
