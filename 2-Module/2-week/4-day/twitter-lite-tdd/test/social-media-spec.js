...
describe("User Class", function () {
    it("should construct the property of `userName`", function () {
        //are we trrying to pass the description or are we trying to pass the mocha test specs? (expect) // THE SPECS!

        // THE CODE IS TRUTH, Not particularly the description, understanding the code below is what will get us the passing score.
        ...
        //.equal("John Quack") expected value that is what we want (correct answer).
        //actual === expected
